...
define(
	...
	function( reqwest, $ )
	{
		...
		function buttonClicked( event )
		{
			...
			if ( ! is_uploading )
			{
				signals['export-requested'].dispatch( upload );
		...
		function imageUploaded( response )
		{
			...
			{
				var twitter_share_url_text = "Check out what I made with @snorpey’s triangulation tool: ";
				...
				facebook_share_url += '&p[summary]=' + encodeURIComponent( 'Check out what I made with this triangulation tool: http://snorpey.github.io/triangulation' );
